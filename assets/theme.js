...
(function(){
  ...
  class PredictiveSearch extends HTMLElement {
    constructor() {
      ...
      this.predictiveSearchResults = this.querySelector('.predictive-search-result');
  ...
  theme.Collection = (function() {
    ...
    Collection.prototype = Object.assign({}, Collection.prototype, {
      ...
      initClear: function() {
        this.resetFilter = document.querySelector(selectors.resetFilter); 
  
        if (this.resetFilter) {
          this.resetFilter.on('click' + this.namespace, this.onClearClick.bind(this));
        }
      },
      ...
      onSortChange: function() {
        ...
        this.queryParams.delete('sort_by'); // Delete if it exists
        this.queryParams.set('sort_by', this.getSortValue());
        this.queryParams.delete('page'); // Delete if it exists
        //console.log(window.location.search);
        this.startLoading();
        //const newUrl = new URL(window.location.href+'?sort_by='+this.getSortValue());
        this.renderCollectionPage(this.queryParams, false);
      ...
      onClearClick: function() {
        ...
        history.replaceState(history.state, '', result);
        this.renderCollectionPage(this.queryParams, false);
      },
